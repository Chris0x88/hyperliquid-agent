...
- Per-section CLAUDE.md files must stay current or new sessions start confused --- documentation is load-bearing.
- The daemon still runs (WATCH tier, 120s tick) but the interface is the primary interaction surface.
