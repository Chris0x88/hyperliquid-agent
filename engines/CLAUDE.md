...
|---------|---------|-----------|
| `analysis/` | Market scanning, technical signals | radar_engine, pulse_engine, apex_engine, context_engine, radar_technicals, market_structure (pure indicators), market_snapshot (`MarketAnalysis` dataclass + `build_snapshot`) |
